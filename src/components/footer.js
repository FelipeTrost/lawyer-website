...
export default ({reference}) => (
    <footer ref={reference}>
        <div class="items">
            <div>
                <h3 class="text-uppercase section-title">Redes sociales</h3>
            ...
            <div>
                <h3 class="text-uppercase section-title">Contácto</h3>
        ...
        <div class="footer-copyright text-center py-3">© 2020 Derechos de autor: <a> Paremos el alza</a>
    </div>
  </footer>
)